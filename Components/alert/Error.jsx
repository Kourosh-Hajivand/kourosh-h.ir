...
function Error({ status, Massage }) {
  ...
  return (
    <div
      className={`bg-[#F44336]/50 text-white max-w-[350px] md:min-w-[200px]  backdrop-blur-[35px] py-4 px-4 rounded-r-2xl flex items-start justify-center flex-col fixed bottom-10 right-10 z-[100] ${
